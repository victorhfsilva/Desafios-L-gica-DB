...
class CalculadoraTest {
    ...
    @Test
    void verificarDividirThrowsArithmeticException(){
    ...
    @Test
    void verificarPotenciacaoThrowsArithmeticException(){
        assertThrows(ArithmeticException.class, () -> {
            Calculadora.calcular(Operacao.POTENCIACAO, 2, -2);
        });
    }
